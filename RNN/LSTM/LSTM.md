...
![Recurrent Neural Networks have loops](./static/image.png)
...
![An unrolled recurrent neural network.](./static/image-1.png)
...
![The repeating module in a standard RNN contains a single layer](./static/image-4.png)

LSTMs also have this chain like structure, but the repeating module has a different structure. Instead of having a single neural network layer, there are four, interacting in a very special way.

![The repeating module in an LSTM contains four interacting layers](./static/image-5.png)
...
We multiply the old state by $f_{t}$, forgetting the things we decided to forget earlier. Then we add $i_{t}∗\tilde{C_{t}}$
...
[References 1](http://colah.github.io/posts/2015-08-Understanding-LSTMs/)
